...
from cvpods.modeling.roi_heads import PointRendROIHeads
from cvpods.modeling.roi_heads.box_head import FastRCNNConvFCHead
from cvpods.modeling.roi_heads.mask_head import CoarseMaskHead
...
def build_roi_heads(cfg, input_shape):
    return PointRendROIHeads(cfg, input_shape)
...
def build_mask_head(cfg, input_shape):
    return CoarseMaskHead(cfg, input_shape)
