...
class RCNNHead(nn.Module):
    ...
    def __init__(self, cfg, d_model, num_classes,
                 dim_feedforward=2048, nhead=8, dropout=0.1, activation="relu",
                 scale_clamp=_DEFAULT_SCALE_CLAMP, bbox_weights=(2.0, 2.0, 1.0, 1.0)):
        super().__init__()
