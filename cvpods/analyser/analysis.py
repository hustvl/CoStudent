...
from cvpods.modeling.nn_utils import (
    activation_count,
    flop_count,
    parameter_count,
...
def flop_count_operators(
    ...
    This is a wrapper of cvpods.modeling.nn_utils.flop_count, that supports
    standard detection models in cvpods.
    ...
    Args:
        model: a cvpods model that takes `list[dict]` as input.
        inputs (list[dict]): inputs to model, in cvpods's standard format.
    """
...
def activation_count_operators(
    ...
    This is a wrapper of cvpods.modeling.nn_utils.activation_count, that supports
    standard detection models in cvpods.
