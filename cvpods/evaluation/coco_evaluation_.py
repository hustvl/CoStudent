...
from cvpods.structures import Boxes, BoxMode, pairwise_iou,Instances
...
class COCOEvaluator(DatasetEvaluator):
    ...
    def process(self, inputs, outputs):
        ...
        for input, output in zip(inputs, outputs):
            ...
            # if isinstance(output,Instances):
            #     prediction["proposals"] = output.get('pred_boxes').to(self._cpu_device)
            #     prediction["proposals_labels"] = instances.get('pred_classes').to(self._cpu_device)
            # el
...
def _evaluate_box_proposals(dataset_predictions, coco_api, thresholds=None, area="all", limit=None):
    ...
    for prediction_dict in dataset_predictions:
        ...
        overlaps = pairwise_iou(prediction_dict["proposals"].proposal_boxes, gt_boxes)
